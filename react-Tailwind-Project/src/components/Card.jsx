    ...
    return (
        <div className="card w-96 rounded-none">
            ...
            <div className="card-body px-0 mx-0">
                ...
                {
                    props.link &&
                    <p className="font-montserrat w-[9vw] max-sm:w-[23vw] flex justify-between text-[#c99484] font-bold text-[0.8rem] group hover:text-black">READ MORE <svg className="w-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048">
