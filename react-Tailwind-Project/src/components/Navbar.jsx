    ...
    return (
        <div className="navbar bg-none p-7 w-full justify-between font-montserrat">
            ...
            <dialog id="my-modal" className="modal">
                <div className="w-full h-full bg-white rounded-none p-10">
                    <form method="dialog">
            ...
            <div className="gap-7 max-sm:hidden">
                <a>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512"
                ...
                <button className="font-montserrat font-bold border border-white text-white text-[0.8rem] px-8 py-2 cursor-pointer hover:bg-white hover:text-black">
                    LET'S TALK
                </button>
            </div>
        </div>
