...
function Footer() {
    return (
        <div className="p-6 bg-[#f3efee] font-montserrat">
            <footer className="footer text-neutral-content max-sm:flex max-sm:flex-col justify-between items-center py-8 pt-[5rem] max-sm:pt-[3rem]">
                ...
                <div className="grid-flow-col gap-8 ">
                    <a>
                        <svg
                            ...
                            viewBox="0 0 576 512"
                            fill="#be7c68"
                            className="hover:fill-black hover:cursor-pointer"
                        >
                            <path
            ...
            <div className="flex justify-between items-center text-[#71818b] text-[0.88rem] py-8 max-sm:flex-col max-sm:gap-6 max-sm:text-[0.9rem] max-sm:pb-3">
